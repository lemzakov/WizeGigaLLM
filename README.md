...
Наши решения: [Фреймворки](#фреймворки) | [SDK для работы с моделями GigaChat](#sdk-для-работы-с-моделями-gigachat) | [Агенты](#агенты) | [Утилиты и MCP-сервера](#утилиты-и-mcp-сервера) | [Web Demo](#web-demo-приложение)
...
[**Web Demo**](/web-demo/) — интерактивное веб-приложение для демонстрации возможностей GigaChat API. Позволяет взаимодействовать с API через удобный веб-интерфейс.

**Возможности:**
* 💬 Интерактивный чат-интерфейс для общения с GigaChat
* ⚙️ Управление настройками API (модель, температура, максимальное количество токенов)
* 🔌 Тестирование подключения к GigaChat API
* 🚀 Готово к развертыванию на Vercel
* 🔐 Безопасное управление API-ключами на серверной стороне

**Технологии:**
* Next.js 14 с TypeScript
* React Server Components
* API Routes для безопасной работы с GigaChat
* Адаптивный дизайн

[Быстрый старт](/web-demo/README.md) | [Руководство по развертыванию](/web-demo/DEPLOYMENT.md)
